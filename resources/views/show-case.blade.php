...
<body>
    <!--Hero Section-->
    <section id="hero" class="py-5" style="background-image: url('https://placehold.co/1920x1080'); background-size: cover; background-position: center; padding-bottom: 100px;">
            ...
            <div class="row">
                <div class="col-md-6" style="background-color: rgba(255, 255, 255, 0.8); padding: 20px;">
                    <small style="background-color: #e1eefe; color: #007bff; padding: 5px 10px; border-radius: 10px;">
                        <i class="fa fa-gear fa-spin"></i> Working for your success
                    </small>
